...
function EditMemberModal({ open, member, onClose, onDone }) {
  ...
  const onFocus = e => { e.target.style.borderColor = 'var(--brand-500)'; e.target.style.boxShadow = '0 0 0 3px rgba(91,79,233,0.18)' }
  const onBlur  = e => { e.target.style.borderColor = 'var(--slate-300)'; e.target.style.boxShadow = 'none' }
