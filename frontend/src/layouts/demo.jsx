...
function PlaceholderContent({ active }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      {/* Hero */}
      <div>
        <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#5B4FE9" }}>{c.eyebrow}</div>
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: 32, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.025em", margin: "8px 0 8px" }}>{c.h1}</h1>
        <p style={{ fontSize: 15, color: "#374151", margin: 0, lineHeight: 1.6, maxWidth: 640 }}>{c.body}</p>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14 }}>
        {[
          ...
          <div key={s.label} style={{ background: "#FFF", border: "1px solid #E2E8F0", borderRadius: 10, padding: "14px 18px", boxShadow: "0 1px 3px rgba(15,23,42,0.04)" }}>
            <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", color: "#6B7280" }}>{s.label}</div>
            <div style={{ fontFamily: "var(--font-display)", fontSize: 26, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.02em", lineHeight: 1.1, marginTop: 4 }}>{s.value}</div>
            <div style={{ fontSize: 12, color: "#059669", fontWeight: 500, marginTop: 2 }}>{s.delta}</div>
          </div>
        ))}
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 16 }}>
        <div style={{ background: "#FFF", border: "1px solid #E2E8F0", borderRadius: 12, padding: 24, boxShadow: "0 1px 3px rgba(15,23,42,0.04)", minHeight: 300 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 600, color: "#0F172A", margin: 0 }}>Recent activity</h3>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
                <div style={{
                  ...
                  background: a.tone === "success" ? "#ECFDF5" : a.tone === "brand" ? "#EFEDFD" : "#F1F5F9",
                  color:      a.tone === "success" ? "#047857" : a.tone === "brand" ? "#5B4FE9" : "#6B7280",
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, color: "#0F172A" }}>
                    <strong>{a.who}</strong> <span style={{ color: "#6B7280", fontWeight: 400 }}>{a.what}</span>
                  </div>
        ...
        <div style={{ background: "#FFF", border: "1px solid #E2E8F0", borderRadius: 12, padding: 24, boxShadow: "0 1px 3px rgba(15,23,42,0.04)" }}>
          <h3 style={{ fontFamily: "var(--font-display)", fontSize: 16, fontWeight: 600, color: "#0F172A", margin: "0 0 14px" }}>Next up</h3>
          {[
            ...
            <div key={i} style={{ display: "flex", gap: 10, alignItems: "center", padding: "12px 0", borderTop: i === 0 ? 0 : "1px solid #F1F5F9" }}>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 12, fontWeight: 600, color: "#0F172A", width: 70, flexShrink: 0 }}>{e.t}</div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 13, fontWeight: 500, color: "#0F172A", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{e.title}</div>
...
function CandidateStepContent({ step }) {
  if (step === "device-check") {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center", textAlign: "center" }}>
        <div style={{ width: 64, height: 64, borderRadius: 16, background: "#EFEDFD", color: "#5B4FE9", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <window.Icon name="mic" size={28} />
        </div>
        <div>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#5B4FE9" }}>Step 1 of 4</div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: 32, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.025em", margin: "8px 0 12px" }}>Let's check your device</h1>
          <p style={{ fontSize: 15, color: "#374151", margin: 0, lineHeight: 1.6, maxWidth: 480 }}>
        ...
        <div style={{ width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginTop: 8 }}>
          {[
            ...
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: 16, background: "#FFF", border: "1px solid #E2E8F0", borderRadius: 10, textAlign: "left" }}>
              <div style={{ width: 36, height: 36, borderRadius: 8, background: c.ok ? "#ECFDF5" : "#FFEDE6", color: c.ok ? "#047857" : "#B53618", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <window.Icon name={c.icon} size={16} />
              </div>
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#0F172A" }}>{c.title}</div>
                <div style={{ fontSize: 12, color: "#6B7280", marginTop: 2 }}>{c.body}</div>
              </div>
              <window.Icon name="check-circle-2" size={16} color="#059669" />
            </div>
          ))}
        </div>
        <button style={{
          marginTop: 8, padding: "12px 28px", border: 0, borderRadius: 10,
          background: "#5B4FE9", color: "#FFF", fontWeight: 600, fontSize: 14,
  ...
  if (step === "consent") {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        <div>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#5B4FE9" }}>Step 2 of 4</div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: 32, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.025em", margin: "8px 0 12px" }}>Recording consent</h1>
        ...
        <div style={{ background: "#FFF", border: "1px solid #E2E8F0", borderRadius: 12, padding: 24, display: "flex", flexDirection: "column", gap: 14 }}>
          {[
            ...
            <div key={i} style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: "#EFEDFD", color: "#5B4FE9", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                <window.Icon name={c.icon} size={14} />
              </div>
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: "#0F172A" }}>{c.title}</div>
                <div style={{ fontSize: 12, color: "#6B7280", marginTop: 2, lineHeight: 1.5 }}>{c.body}</div>
              </div>
            </div>
          ))}
        </div>
        <label style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 13, color: "#374151", cursor: "pointer", padding: 14, background: "#F8FAFC", border: "1px solid #E2E8F0", borderRadius: 10 }}>
          <input type="checkbox" defaultChecked style={{ marginTop: 2, width: 16, height: 16, accentColor: "#5B4FE9" }} />
          <span>I agree to have this interview recorded and processed under Screeno's <a style={{ color: "#5B4FE9", fontWeight: 500 }}>privacy policy</a>.</span>
        </label>
  ...
  if (step === "interview") {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        <div>
          <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#5B4FE9" }}>Question 2 of 6</div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: 28, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.02em", margin: "8px 0 4px", lineHeight: 1.25 }}>
            Walk me through a recent backend service you built. What was the trickiest decision?
          </h1>
          <p style={{ fontSize: 13, color: "#6B7280", margin: "8px 0 0" }}>Take a breath, then speak in your own words. The AI will follow up if needed.</p>
        </div>
        <div style={{ background: "#FFF", border: "1px solid #DEDAFB", borderRadius: 14, padding: 32, display: "flex", flexDirection: "column", alignItems: "center", gap: 18, boxShadow: "0 8px 24px rgba(91,79,233,0.06)" }}>
          <div style={{ width: 80, height: 80, borderRadius: 9999, background: "linear-gradient(135deg, #5B4FE9, #4A3FCE)", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 8px 24px rgba(91,79,233,0.25)", animation: "pulse 2s ease-in-out infinite" }}>
            <window.Icon name="mic" size={28} color="#FFF" />
          </div>
          <div style={{ display: "flex", gap: 4, alignItems: "center", height: 36 }}>
            {[...Array(16)].map((_, i) => (
              <span key={i} style={{
                width: 3, height: 32,
                background: "#5B4FE9", borderRadius: 9999,
                transformOrigin: "center",
                animation: `eqBar 1.2s ease-in-out ${i * 70}ms infinite`,
              }} />
            ))}
          </div>
          <div style={{ fontSize: 13, fontWeight: 500, color: "#5B4FE9" }}>Listening…</div>
        </div>
        <style>{`
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24, alignItems: "center", textAlign: "center" }}>
      <div style={{ width: 80, height: 80, borderRadius: 9999, background: "#ECFDF5", color: "#047857", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <window.Icon name="check" size={36} />
      </div>
      <div>
        <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", color: "#047857" }}>Step 4 of 4</div>
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: 32, fontWeight: 700, color: "#0F172A", letterSpacing: "-0.025em", margin: "8px 0 12px" }}>All done — nice work.</h1>
        <p style={{ fontSize: 15, color: "#374151", margin: 0, lineHeight: 1.6, maxWidth: 480 }}>
...
const btnSecondary = {
  padding: "11px 18px", border: "1px solid #CBD5E1", borderRadius: 10,
