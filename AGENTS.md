...
> Auto-loaded every Codex session. See `docs/INDEX.md` for links to all other files.
...
Full connection setup: `.Codex/skills/db-access.md`
...
├── .Codex/skills/     ← Action skills     → see docs/INDEX.md
├── skills/             ← Guidelines
